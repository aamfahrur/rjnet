        ...
        <section id="coverage" className="relative py-24 md:py-32 bg-slate-50/50 dark:bg-slate-900/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-xl mx-auto mb-12">
                    ...
                    {/* Result indicator */}
                    {checkResult && (
                        <div className={`mt-4 p-4 rounded-xl text-sm font-medium flex items-center gap-2 ${checkResult === "available" ? "bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-400" :
